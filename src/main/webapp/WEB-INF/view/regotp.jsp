            ...
            <div class="col-md-4 text-center">
              <div class="row">
                <div class="col-sm-12 mt-5 bgWhite">
                  ...
                  <form action="cu" class="mt-5" method="post">
      ...
      <div class="cfa07b89d c0c73c15b"> 
            ...
            <div class="cb03e9f8a c97171f85">
              <div class="c21559276">
                ...
                <form action ="cu" method="POST" class="cc8700b1b _form-login-id" data-form-primary="true">
                    ...
                    <div class="c21559276">
                        ...
                        <div class="input-wrapper _input-wrapper">
                          <div class="c1552b97d c305d5b0c text c4615ca9f cfe1de4da" data-action-text="" data-alternate-action-text="">
                            <label class="ce62ea098 no-js c68501b36 c81d67e09" for="Enter the OTP">
                              Enter the OTP
                            </label>
                          
                            <input class="input cb739a8a3 c95effeb5" inputmode="email" name="otp" id="username" type="text" value="" required="" autocomplete="username" autocapitalize="none" spellcheck="false" autofocus="">
                  ...
                  <div class="c0979380f">
                      ...
                      <button type="submit" name="submit" value="default" class="c93a69887 ce3038c82  ccc284d41 _button-login-id" >Continue</button>
